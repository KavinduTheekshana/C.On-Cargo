        ...
        <div>
            <div class="card-body">
                <div style="width: 100%; justify-content: space-between">
                    <div class="mb-xl-0 pb-3" style="width: 100%">
                    ...
                    {{-- <div style="width: 10%">
                        ...
                        <br>
                        <div>
                            {!! DNS1D::getBarcodeHtml("$invoice->invoice_id", 'C128', 1.2, 60) !!}
                          <p style="font-size: 12px">C.On Cargo {{ $invoice->invoice_id }}</p>
                        </div>
                    </div> --}}
                </div>
            </div>
            <hr class="my-0" />
            <div class="card-body">
                <div class="row" style="font-size: 11px; width: 100%">
                    <div class="col-md-6 vertical-line line" style="width: 45%">
