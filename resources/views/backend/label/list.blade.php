                ...
                <table id="invoice" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button"
                                class="btn btn-icon btn-dark btn-fab demo waves-effect waves-light m-1" data-bs-toggle="modal" title="View Invoice"
                            ...
                            <a type="button" href="{{ route('invoice.label.preview', ['id' => $item->id]) }}" title="label"
