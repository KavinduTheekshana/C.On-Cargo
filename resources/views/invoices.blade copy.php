...
<body>
    ...
    <div>
        <div>
            <div class="card-body">
                <div class="d-flex justify-content-between flex-xl-row">
                    <div class="mb-xl-0 pb-3">
                        <div class="d-flex svg-illustration align-items-center gap-2 mb-4">
                            <span class="app-brand-logo demo">
                                <img width="140px" src="{{ asset('frontend/assets/img/logo/logo.svg') }}" alt="" />
                            </span>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 justify-center text-center" style="width: 100%">
                        <p>C.on Group Ltd - 12, King Arthur Road, Waltham Cross, London, EN8 8EH &nbsp; <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
